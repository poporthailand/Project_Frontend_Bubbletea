  ...
  <div class="ctn">
    ...
    <div class="Body">
      ...
      <div class="rightbody">
        ...
        >
          <center>
            <p style="font-size: 50px; font-weight: bold">Preview</p>
            <div>
              <div
                style="
                  width: 393px;
            ...
            <div style="margin-top: 10px">
              <p style="font-size: 20px">จำนวนสินค้าในคลัง : {{ quantity }}</p>
            </div>
            <div style="margin-top: 20px">
              <span>{{ message }}</span>
            </div>
            <div style="margin-top: 5px">
              <span>ราคา : {{ tmp }} บาท</span>
            </div>
            <div v-show="btn" style="margin-top: 5px">
              <span>จำนวน</span>
              <input
                @click="totalprice"
                type="number"
