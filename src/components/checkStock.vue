      ...
      -->
        ...
        <table border="1">
          <Tbody>
            <tr>
              <td
                style="height: 109px; width: 2000px"
                v-for="product in products.slice(0, 5)"
                :key="product._id"
              >
                <p style="font-weight: bold; margin: 0 0 0 0">
                  {{ product.name }}
                </p>
                <p style="font-weight: bold; margin: 0 0 0 0">
                  คงเหลือ {{ product.quantity }} แก้ว
                </p>
                <router-link
                  :to="{ name: 'insertProduct', params: { id: product._id } }"
                  ><button class="insert">เพิ่ม</button></router-link
                >
              </td>
            </tr>
          </Tbody>
